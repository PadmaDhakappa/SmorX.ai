...
const group = NAV_GROUPS.find(g => g.id === 'marketplace')
const picks = ['Voice AI Agent', 'IT Operations Agent', 'Sales Intelligence Agent']
const items = group.items.filter(i => picks.includes(i.label))
const ACCENT = COLORS.violetBright
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 sm:w-56 flex-shrink-0">
        ...
        <h3 className="text-sm font-semibold text-white">Deploy an Agent Today</h3>
      </div>
